...
I learned how we can send anything as action. even a function. that was pretty new to me. Although conventions are useful. it's vital that we understand the API.
