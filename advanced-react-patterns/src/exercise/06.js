...
function useControlledSwitchWarning(
  ...
  React.useEffect(() => {
    warning(
      ...
      `you cannot go from uncontrolled to controlled. you gotta choose one! ${componentName} = for prop ${controlPropName}`,
    )
    warning(
      !(!onIsControlled && wasOnControlled),
      `you cannot go from controlled to uncontrolled. you gotta choose one! ${componentName} = for prop ${controlPropName}`,
    )
  }, [componentName, controlPropName, onIsControlled, wasOnControlled])
}
...
function useOnChangeReadOnlyWarning(
  ...
  React.useEffect(() => {
    warning(
      ...
      `provide an OnChange handler. for ${componentName} = ${controlPropName}`,
    )
