...
Learned about how side-effects are run using `useEffect`. and we need to specify all the things that are using inside the `useEffect` as deps. Also, learned about the hook flow.
