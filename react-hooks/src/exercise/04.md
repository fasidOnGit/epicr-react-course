...
I learned how to lift a state up to a parent component when a requirement changes. and how useEffect and setSomeState should be used very carefully to avoid infinite calling.
most importantly, I learned how we can derive state from a managed state
